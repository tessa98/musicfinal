...
compmus_long_distance(
    ...
    geom_tile() +
    scale_fill_continuous(type = 'viridis', guide = 'none') +
    labs(x = 'Shallow by Lady Gaga', y = '7/11 by Beyoncé') +
    theme_minimal()
...
compmus_long_distance(
    ...
    geom_tile() +
    scale_fill_continuous(type = 'viridis', guide = 'none') +
    labs(x = 'Wolves by Selena Gomez', y = 'Shallow by Lady Gaga') +
    theme_minimal()

```

***
Here we can observe the comparison of the time warping between the three songs.  Clearly the 2016 cation and the 2018 cation have more in common than the 2017 song with any of the others. 
...
*** 
What do the most listened to songs sung by women in 2016 and 2018 have in common? As we can see in 2018 there was a more general tendency to music with a much more developed tempo (btw). And a much higher timbre in general. While 2016 resulted in a year in which the music was "quieter" and with a lower timbre. 
...
***
The ratio of the tempo between 2017 and 2018 is more equal than in 2016, we see the beginning of the trend. And at the same time the timbre is also much more equal than the previous year. Were we suffering an evolution towards the music of 2018? 
...
***
Here what we can observe is that there is a similarity between *wolves*, which represent the first two graphs, and *7/11* of Beyoncé which are the next two, however the *shallow* song of 2018 breaks a small pattern that we could have found. 
